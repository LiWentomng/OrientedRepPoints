...
class OBBPointAssigner(BaseAssigner):
    """
    ...
    def assign(self, points, gt_obboxes, gt_obboxes_ignore=None, gt_labels=None):
        ...
        Args:
            ...
            gt_oboxes_ignore (Tensor, optional): Ground truth oboxes that are
                labelled as `ignored`, NOTE: currently unused.
